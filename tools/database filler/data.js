...
let products = require('./dataProducts')
...
units.forEach(unit => {
  unit.product = products[random(0,products.length - 1)]
})

const rentals = require('./generateRentals.js').generate(customers, employees, units, 400); 
